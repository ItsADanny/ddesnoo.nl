...
<html lang="en">
    ...
    <body>
        ...
        <div class="px-4 pt-5 my-5 text-center border-bottom hero">
            ...
            <h1 class="display-4 fw-bold hero-text">Danny de Snoo</h1>
        ...
        <div class="container main-text-color">
          <div class="row featurette">
            <div class="col-md-7">
              ...
              <p class="lead">I am a Software developer from the Rotterdam area in the Netherlands<br><br>I'm a nice fun and friendly person, with a passion for software development and classic cars.<br>I work well in teams but can also work on my own.<br>I am always up for a challange and willing to learn.<br><br>I am currently enployed at Odin Warehousing & Logistics B.V. as a IT Specialist<br><br>For more information about my career, please go the career page on this website or go to my <a href="https://www.linkedin.com/in/ddesnoo/" target="_blank">Linkedin <i class="fa-brands fa-linkedin"></i></a><br>If you want direct contact via e-mail you can use: <a href="mailto:danny.desnoo@ddesnoo.nl">danny.desnoo@ddesnoo.nl <i class="fa-solid fa-square-envelope"></i></a> or via the contact button on the navigation bar <a data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">(or you can just click here)</a></p>
            </div>
            <div class="col-md-5">
                  ...
                  <div class="col-lg-4 mb-3 d-flex align-items-stretch">
                    <div class="card shadow-sm">
                      ...
                      <div class="card-body">
                        ...
                        <table>
                          <tr>
                            <th><i class="fa-solid fa-earth-europe"></i></th><td> </td><td>Hoogvliet / Maasvlakte, The Netherlands 🇳🇱</td>
                          </tr>
                          <tr>
                            <th><i class="fa-solid fa-calendar-days"></i></th><td> </td><td>August 2022 - Present</td>
                          </tr>
                        </table>
                          <hr>
                          <br>
                  ...
                  <div class="col-lg-4 mb-3 d-flex align-items-stretch">
                    <div class="card shadow-sm">
                      ...
                      <div class="card-body">
                        ...
                        <table>
                          <tr>
                            <th><i class="fa-solid fa-earth-europe"></i></th><td> </td><td>Spijkenisse, The Netherlands 🇳🇱</td>
                          </tr>
                          <tr>
                            <th><i class="fa-solid fa-calendar-days"></i></th><td> </td><td>May 2021 - November 2022</td>
                          </tr>
                        </table>
                        <hr>
                        ...
                        <table>
                          ...
                          <tr>
                            <th><i class="fa-solid fa-calendar-days"></i></th><td> </td><td>September 2020 - May 2021</td>
                          </tr>
                        </table>
                        <hr>
                        <br>
                  ...
                  <div class="col-lg-4 mb-3 d-flex align-items-stretch">
                    <div class="card shadow-sm">
                      ...
                      <div class="card-body">
                        ...
                        <table>
                          <tr>
                            <th><i class="fa-solid fa-earth-europe"></i></th><td> </td><td>Hellevoetsluis, The Netherlands 🇳🇱</td>
                          </tr>
                          <tr>
                            <th><i class="fa-solid fa-calendar-days"></i></th><td> </td><td>October 2017 - April 2018</td>
                          </tr>
                        </table>
                        <hr>
                        <br>
          ...
          <footer id="footer" class="bg-dark text-white d-flex-column text-center">
            ...
            <div class="main-text-color py-3 text-center">
                <p>“The proper function of man is to live, not to exist. I shall not waste my days in trying to prolong them. I shall use my time.”</p>
	              <h6>― Jack London</h6>
                <p>“Tijd regelt de eeuwigheid” / "Time makes eternity"</p>
	              <h6>― Jakob Poot</h6>
              </div>
              <!--/.Copyright-->
            <!--Copyright-->
